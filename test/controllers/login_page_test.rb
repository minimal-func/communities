...
class LoginPageTest < ActionDispatch::IntegrationTest
  ...
  test "root renders the landing page" do
    ...
    assert_response :success
    assert_select "h1", "Grow a greener, kinder way to live together."
    assert_select "a[href='#{login_path}']", "Enter your community"
    assert_select "a.donate-card[href='https://buymeacoffee.com/ildar.safin'][target='_blank'][rel='noopener']"
  end
end
