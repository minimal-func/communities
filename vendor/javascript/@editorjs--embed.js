...
/**
   ...
   */onPaste(e){var t;const{key:i,data:r}=e.detail,{regex:o,embedUrl:a,width:l,height:d,id:s=e=>e.shift()||""}=m.services[i],n=(t=o.exec(r))==null?void 0:t.slice(1),h=n?a.replace(/<%= remote_id %>/g,s(n)):"";this.data={service:i,source:r,embed:h,width:l,height:d}}
/**
...
/**
   ...
   */embedIsReady(e){let t;return new Promise(((r,o)=>{t=new MutationObserver(i.debounce(r,450)),t.observe(e,{childList:!0,subtree:!0})})).then((()=>{t.disconnect()}))}}export{m as default};
