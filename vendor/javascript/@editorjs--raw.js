// @editorjs/raw@2.5.1 downloaded from https://ga.jspm.io/npm:@editorjs/raw@2.5.1/dist/raw.mjs
...
/**
   ...
   */constructor({data:e,config:t,api:a,readOnly:r}){this.api=a,this.readOnly=r,this.placeholder=a.i18n.t(t.placeholder||s.DEFAULT_PLACEHOLDER),this.CSS={baseClass:this.api.styles.block,input:this.api.styles.input,wrapper:"ce-rawtool",textarea:"ce-rawtool__textarea"},this.data={html:e.html||""},this.textarea=null,this.resizeDebounce=null
/**
   * Return Tool's view
   *
...
/**
   ...
   *
   * @returns {void}
   */}resize(){this.textarea.style.height="auto",this.textarea.style.height=this.textarea.scrollHeight+"px"}}export{s as default};
