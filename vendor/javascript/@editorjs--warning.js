...
/**
   ...
   */constructor({data:e,config:t,api:a,readOnly:n}){this.api=a,this.readOnly=n,this.titlePlaceholder=(t==null?void 0:t.titlePlaceholder)||i.DEFAULT_TITLE_PLACEHOLDER,this.messagePlaceholder=(t==null?void 0:t.messagePlaceholder)||i.DEFAULT_MESSAGE_PLACEHOLDER,this.data={title:e.title||"",message:e.message||""}
/**
   * Create Warning Tool container with inputs
   *
   * @returns {Element} Html element of Warning Tool.
   */}render(){const e=this._make("div",[this.CSS.baseClass,this.CSS.wrapper]),t=this._make("div",[this.CSS.input,this.CSS.title],{contentEditable:!this.readOnly,innerHTML:this.data.title}),a=this._make("div",[this.CSS.input,this.CSS.message],{contentEditable:!this.readOnly,innerHTML:this.data.message});return t.dataset.placeholder=this.titlePlaceholder,a.dataset.placeholder=this.messagePlaceholder,e.appendChild(t),e.appendChild(a),e
/**
   ...
   */}save(e){const t=e.querySelector(`.${this.CSS.title}`),a=e.querySelector(`.${this.CSS.message}`);return Object.assign(this.data,{title:(t==null?void 0:t.innerHTML)??"",message:(a==null?void 0:a.innerHTML)??""})}
/**
   ...
   */_make(e,t=null,a={}){const n=document.createElement(e);Array.isArray(t)?n.classList.add(...t):t&&n.classList.add(t);for(const e in a)n[e]=a[e];return n}static get sanitize(){return{title:{},message:{}}}}export{i as default};
